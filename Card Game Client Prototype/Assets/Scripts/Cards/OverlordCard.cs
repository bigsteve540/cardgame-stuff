...
[CreateAssetMenu(fileName = "New Overlord", menuName = "Cards/Overlord", order = 0)]
public class OverlordCard : Card, ICombatable
{
    [SerializeField] private string cardID = "$NULL$";
    public override string CardID { get { return cardID; }  }

    private Card_Type cardType = Card_Type.Overlord;
